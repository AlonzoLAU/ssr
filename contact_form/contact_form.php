...
// configure
$from = 'realchongliu@gmail.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = '1160300207@stu.hit.edu.cn'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6Lf-jX4aAAAAAIv8CH7JTe2fYWIee2ZuxDhJF59i';
